...
class ChangelogCatalogTest {
  ...
  fun `latestVersionAtOrBefore reuses the newest compatible catalog entry`() {
    ...
    assertEquals("0.22.18", ChangelogCatalog.latestVersionAtOrBefore("0.22.18"))
    assertEquals("0.22.18", ChangelogCatalog.latestVersionAtOrBefore("0.22.99"))
  }

  @Test
  fun `history is sorted from newest to oldest`() {
    assertEquals(
      listOf("0.22.18", "0.22.17", "0.22.9", "0.22.2", "0.21.1", "0.21.0", "0.19.0", "0.18.1"),
